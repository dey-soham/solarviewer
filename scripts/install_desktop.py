...
def install_desktop_integration():
    ...
    if desktop_template.exists():
        ...
        updated_content = updated_content.replace("Icon=solarviewer", f"Icon={target_icon_path}")
    ...
    try:
        ...
        run(["gtk-update-icon-cache", str(icons_base)], 
            stdout=DEVNULL, stderr=DEVNULL)
